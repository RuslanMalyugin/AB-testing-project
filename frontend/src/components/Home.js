        ...
        <main className='Main'>
            <div className='BannerRight'>
                ...
                <div className='LongText'>
                    ...
                    показатели работы двух вариантов веб-страницы, а также <br/>
                    сравнивать их между собой. Также А/В-тестирование помогает <br/>
                    оценивать эффективность изменений страницы, например, <br/>
                    добавления новых элементов дизайна или призывов к действию. <br/>
                    А/В-тестирование начинается с оценки метрик существующей <br/>
                    веб-страницы А и подбора критерия эффективности изменений. <br/>
                    Затем трафик разделяется между страницами A и B на две <br/>
